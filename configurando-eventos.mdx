...
6. no campo **Nome do evento**, informe `purchase`;
   ...
   <Image src="https://versao.beefood-r2.work/imagens-manual/gtm/add-purchase-in-event-name.png" width="1899" height="902" alt="" />
